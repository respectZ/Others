...
body.setTextureOffset( 33, 23,true);
body.addBox(-1,12,-2, 3, 6, 3);
body.setTextureOffset( 56, 6,true);
body.addBox(0,12,-3, 1, 8, 1);
body.setTextureOffset( 58, 19,true);
body.addBox(0,12,1, 1, 8, 1);
body.setTextureOffset( 49, 22,true);
body.addBox(0,18,-2, 1, 6, 1);
body.setTextureOffset( 39, 21,true);
